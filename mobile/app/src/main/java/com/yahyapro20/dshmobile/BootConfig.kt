...
object BootConfig {
    ...
    const val NODE_URL =
        "https://nodejs.org/dist/v22.19.0/node-v22.19.0-linux-arm64.tar.gz"
    
    const val NODE_DIR_NAME = "node-v22.19.0-linux-arm64"
    
    // SHA256 Checksums (optional - leave empty to skip verification)
    const val PROOT_SHA256 = ""
    ...
    const val LOCAL_NODE_FILENAME = "node.tar.gz"  // Changed from .tar.xz
